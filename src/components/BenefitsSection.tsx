...
const icons = [Clock, TrendingUp, HeadphonesIcon, ShieldCheck, Star];
      ...
      <div className="container">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16">
          <div className="grid sm:grid-cols-2 gap-4 md:gap-6">
            {t.benefits.items.slice(0, 4).map((benefit, index) => {
        ...
        <ScrollReveal animation="fade-up" delay={300}>
          <div className="max-w-md mx-auto">
            <div className="group relative p-6 md:p-8 rounded-2xl bg-card border border-border hover:border-primary/30 hover:shadow-card transition-all duration-300 text-center">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">{t.benefits.items[4].title}</h3>
              <p className="text-muted-foreground">{t.benefits.items[4].description}</p>
            </div>
          </div>
        </ScrollReveal>
      </div>
