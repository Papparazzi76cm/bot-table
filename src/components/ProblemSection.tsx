      ...
      <div className="container">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {problems.map((problem, index) => (
            <div
              key={problem.title}
              className="group p-6 md:p-8 rounded-2xl bg-background border border-border hover:border-destructive/30 hover:shadow-lg transition-all duration-300 animate-fade-up"
